...
const gallaryItems = images.map(({preview, original, description}) => `<li class="gallery-item">
...
gallery.addEventListener('click', (event) => {
  ...
  //  создаем мод окно лайтбокс
    const instance = basicLightbox.create(`<img src="${originalSrc}" width="800" height="600">`)
    instance.show();
  }
